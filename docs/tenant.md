...
Upon creation, the tenant receives a unique `ID`.
...
| Task | Description |
|------|-------------|
| **Invite Users** | Create user accounts directly and share invitation tokens. |
...
- **Effect:** Marks `deleted_at`, deactivates the tenant.
---
